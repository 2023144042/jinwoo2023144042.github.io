...
function setupKeyboardEvents() {
    document.addEventListener('keydown', (event) => {
        if (event.key == 'a') {
            ...
            shaderlevel=1;
            updateText(textOverlay3, "toon levels: " + shaderlevel);
            render();
        }
...
function render() {
    ...
    shader.setInt('level',shaderlevel);
...
async function main() {
    try {
        ...
        shader.setVec3("material.diffuse", vec3.fromValues(1.0, 0.4, 0.0));
        shader.setVec3("material.specular", vec3.fromValues(0.8, 0.8, 0.8));
        shader.setFloat("material.shininess", shininess);
        shader.setVec3("u_viewPos", cameraPos);
        shader.setVec3("u_viewPos", cameraPos);
        shader.setInt("level",3);
        ...
        textOverlay3 = setupText(canvas, "toon levels : " + shaderlevel, 3);
